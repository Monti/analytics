...
LIQUIDITY_DATA = os.path.join(DIST_DIR, 'data/liquidity.json')

PROVIDERS_DATA = os.path.join(DIST_DIR, 'data/providers/{}.json')

ROI_DATA = os.path.join(DIST_DIR, 'data/roi/{}.json')

VOLUME_DATA = os.path.join(DIST_DIR, 'data/volume/{}.json')

TOTAL_VOLUME_DATA = os.path.join(DIST_DIR, 'data/total_volume.json')
